...
async def refercall(bot, query):
    btn = [[
        InlineKeyboardButton('ɪɴᴠɪᴛᴇ ʟɪɴᴋ', url=f'https://telegram.me/share/url?url=https://telegram.me/{bot.me.username}?start=reff_{query.from_user.id}&text=Hello%21%20Experience%20a%20bot%20that%20offers%20a%20vast%20library%20of%20unlimited%20movies%20and%20series.%20%F0%9F%98%83'),
...
async def auto_filter(client, msg, spoll=False , pm_mode = False):
    if not spoll:
        ...
        searching_animation_msg = await client.send_animation(
            chat_id=chat_id,
            animation="https://envs.sh/YBM.mp4",  # Animation URL
            caption=f'🔎 ꜱᴇᴀʀᴄʜɪɴɢ.... {search} ᴘʟᴇᴀꜱᴇ ᴡᴀɪᴛ 𝟣𝟢 ꜱᴇᴄ'
        )
